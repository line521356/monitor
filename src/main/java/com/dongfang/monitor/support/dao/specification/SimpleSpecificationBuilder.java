package com.dongfang.monitor.support.dao.specification;
...
public class SimpleSpecificationBuilder<T> {
	...
	public static<T> SimpleSpecificationBuilder init(String key,String oper,Object value) {
    	return new SimpleSpecificationBuilder<T>(key, oper, value);
    }
